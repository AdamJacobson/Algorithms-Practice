...
describe 'Blair Numbers' do
  ...
  it 'works from bottom up' do
    expect(dp.blair_nums_bu(6)).to equal(48)
    expect(dp.blair_nums_bu(100)).to eq(2782118076579236997325)
    expect { dp.blair_nums_bu(1000) }.to perform_under(100).ms
  end
end
